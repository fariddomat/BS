...
@section('content')
   @if ($service->slug=='malak-screen')
   <div class="blog-home section-padding pt-4 px-md-5 mx-md-3"
   style="min-height: 100vh; margin: 0 !important; padding: 80px  !important ;background-image: url({{ asset($service->index_image) }});background-size: cover;">
           ...
           <div class="col-md-12">
               <div class="item animate-box" data-animate-effect="fadeInUp">
                               ...
                               @foreach ($section->images as $sectionImage)
                                   <div class="col-12 col-md">
                                       <div class="pt-3 text-center">
                                           ...
                                           <figcaption class="text-center service-section-image-caption">
                                               {{ $sectionImage->caption }}</figcaption>
                                       </div>
                                   </div>
                               @endforeach
                           </div>
                       ...
                       <div class="row mt-5">
                           ...
                           @foreach ($service->workWays as $work)
                               <div class="col-12 col-md-6 mt-3"
                                   @if ($loop->even) data-aos="fade-up"
                           @else
                           data-aos="fade-down" @endif
                                   data-aos-duration="2000" data-aos-offset="100" data-aos-delay="50">
                                   <div class="flip-box">
                       ...
                       <div class="row mt-5">
                           <div class="col-12">
                               <div class="text-center wrapper1">
                                   ...
                                   <div>
                                       <a href="{{ route('service.order', $service->slug) }}" class="wrapper1-a">
                   ...
                   <div class="row">
                       ...
                       @else
                       data-aos="fade-down" @endif
                               data-aos-duration="2000" data-aos-offset="200" data-aos-delay="50">
