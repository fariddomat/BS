...
<div id="content" class="nopadding">
    <section id="section-about-us-4" class="side-bg no-padding">
        <div class="image-container col-lg-5 col-md-12 pull-left" data-delay="0" style="background: url({{ asset($aboutImages[0]->image) }});"></div>
    ...
    <section id="section-about-us-4" class="side-bg no-padding">
        <div class="image-container col-lg-5 col-md-12 pull-left" data-delay="0" style="right: 0; background: url({{ asset($aboutImages[1]->image) }}); "></div>
    ...
    <section id="section-about-us-4" class="side-bg no-padding">
        <div class="image-container col-lg-5 col-md-12 pull-left" data-delay="0" style="background: url({{ asset($aboutImages[2]->image) }});"></div>
    ...
    <section id="section-about-us-4" class="side-bg no-padding">
        <div class="image-container col-lg-5 col-md-12 pull-left" data-delay="0" style="right: 0; background: url({{ asset($aboutImages[3]->image) }}); "></div>
    ...
    <section id="section-about-us-4" class="side-bg no-padding">
        <div class="image-container col-lg-5 col-md-12 pull-left" data-delay="0" style="background: url({{ asset($aboutImages[4]->image) }});"></div>
    ...
    <section id="section-about-us-4" class="side-bg no-padding">
        <div class="image-container col-lg-5 col-md-12 pull-left" data-delay="0" style="right: 0; background: url({{ asset($aboutImages[5]->image) }}); "></div>
    ...
    <section id="section-about-us-4" class="side-bg no-padding">
        <div class="image-container col-lg-5 col-md-12 pull-left" data-delay="0" style="background: url({{ asset($aboutImages[6]->image) }});"></div>
    ...
    <section id="section-about-us-4" class="side-bg no-padding">
        <div class="image-container col-lg-5 col-md-12 pull-left" data-delay="0" style="right: 0; background: url({{ asset($aboutImages[7]->image) }}); "></div>
    ...
    <section id="view-all-projects" class="call-to-action bg-color dark text-center" data-speed="5"
        ...
        <a href="{{ route('contact') }}" class="btn-line btn-big" style="color:white">@lang('contact.get_in_touch')</a>
    </section>
