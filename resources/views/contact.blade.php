...
<div id="contact" class="section-padding" style="background: #fff; padding-top: 100px; padding-left:15px; padding-right: 15px;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="heading-title">@lang('contact.connect')</h2>
        ...
        <div class="row">
            ...
            <div class="col-md-6" >
                ...
                <form id="contactFrom" method="post" action="{{ route('contact.post') }}" class="row">
                    ...
                    <div class="col-md-6">
                        <input type="number" min="0" name="mobile" value="{{ old('mobile') }}" class="form-control"
                            placeholder="@lang('contact.mobile')" required>
                    </div>
