        ...
        <div class="col">
            <form action="{{ route('dashboard.services.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="ar[main_title]" class="form-control" value="{{ old('ar.main_title') }}" dir="rtl">
                </div>
                <div class="form-group mb-3">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="ar[index_name]" class="form-control" value="{{ old('ar.index_name') }}" dir="rtl">
                </div>
                <div class="form-group mb-3">
