...
class SiteController extends Controller
{
    ...
    {
        $blogCategories = BlogCategory::where('showed', 1)->orderBy('position', 'asc')->get();
        $blogs = Blog::with(['category'])->where('showed', 1)->paginate(8);
    ...
    public function profile()
    {
        ...
        if (App::getLocale() == 'en') {
            $file = public_path() . "/pdf/Digitsmark Profile-En V06.pdf";
        } else {
            $file = public_path() . "/pdf/Digitsmark Profile-Ar V06.pdf";
        }
